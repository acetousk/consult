...
class RestApiTests extends Specification {
    ...
    def cleanupSpec() {
        long totalTime = System.currentTimeMillis() - screenTest.consultTime
    ...
    @Unroll
    def "call consult REST API (#requestMethod, #screenPath, #containsTextList)"() {
        expect:
        ...
        // Test consult Rest API here
        // "put" | "s1/consult/exampleendpoint" | [moquiSessionToken:token] | ['55800']
    }
}
