...
<#--                &lt;#&ndash; nav plugins See in root ComVue.qvt.ftl &ndash;&gt;-->
<#--                &lt;#&ndash;            <template v-for="navPlugin in navPlugins"><component :is="navPlugin"></component></template>&ndash;&gt;-->

<#--                &lt;#&ndash; notify history See in root ComVue.qvt.ftl &ndash;&gt;-->

<#--                &lt;#&ndash; screen history menu See in root ComVue.qvt.ftl &ndash;&gt;-->
